    ...
    <div className="min-h-screen bg-dark-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="glass rounded-2xl p-7">
          <h2 className="font-display text-xl font-bold text-white mb-1">স্বাগতম 👋</h2>
          <p className="text-gray-500 text-sm mb-6 font-body">তোমার journey শুরু করো</p>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-800 font-medium py-3.5 px-6 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl active:scale-95 disabled:opacity-50"
          >
            {loading ? (
            ...
            <span className="font-body">Google দিয়ে Login করো</span>
          </button>

          <p className="text-center text-xs text-gray-600 mt-4 font-body">
            Login করলে তুমি আমাদের Terms of Service মেনে নিচ্ছো
          </p>
        </div>
